                ...
                <div className="logo_location">
                    ...
                    <div className="location" >
                        <Link to={'/location'} style={{textDecoration:'none', color:'#fff'}}>
                            <p className='text-muted' style={{margin:'0', padding:'0', marginLeft:'1.5rem', fontSize:'0.8rem'}}>Delivering to Bhubaneswar 752101</p>
                            <p style={{margin:'0', padding:'0', marginTop:'-7px'}}><i style={{fontSize:'1rem'}} class="fa-solid fa-location-dot"></i> <b>Update location</b></p>
                        </Link>
                    </div>
                </div>
